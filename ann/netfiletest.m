...
%Input:
%   myNet -- Neural Network struct
%   testX -- example inputs
%   testY -- exmaple outputs
%   marker -- delimiter array to separate files from one another
%Return:
%   f -- number of files being tested
...
function [f,distrib_matrix] = netfiletest(myNet, testX, testY, marker)
    ...
    % compute partial sums for each language and total some for all languages
